package sparkTut.advanced.accumulator;

import sparkTut.rdd.commons.Utils;
...
public class StackOverFlowSurveyFollowUp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        JavaRDD<String> responseRDD = javaSparkContext.textFile(Utils.getFile("2016-stack-overflow-survey-responses.csv"));
